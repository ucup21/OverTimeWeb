 ...
 * @author hp
 */
@WebServlet(name = "JenisLemburInsert", urlPatterns = {"/jenisLemburInsert"})
public class JenisLemburInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (aO.insert(jenisLembur)) {
                String berhasil = "Berhasil menambah data dengan ID :" + jenisLembur.getKdLembur();
                session.setAttribute("berhasil", berhasil);
            }else {
                String gagal = "Gagal menambah data";
