 ...
 * @author hp
 */
@WebServlet(name = "UbahPasswordManagerServlet", urlPatterns = {"/ubahPasswordManagerServlet"})
public class UbahPasswordManagerServlet extends HttpServlet {
